...
maxit = 10000;
m=20;
[ Ws, Vs, it, flag ] = subspace_iter_v0( Sigma2, m, eps, maxit )
V_2=Vs; 
D=diag(Ws);
...
% calcul du contraste sans masque
  contraste_sans_masque = cumsum(lambda)/sum(lambda);
% calcul du contrast des 3 premiers composantes avec masque
contraste_masque = cumsum(lambda_masque)/sum(lambda_masque);
save eigenfaces;
